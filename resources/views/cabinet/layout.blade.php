        ...
        <aside class="w-64 bg-white border-r border-brand-border flex-shrink-0 sticky top-0 h-screen overflow-y-auto">
            ...
            <nav class="p-4">
                ...
                <div class="mt-4 pt-4 border-t border-brand-border">
                    @if(auth()->user()->hasAnyRole(['manager', 'admin']))
                    <a href="/manager/" class="flex items-center gap-3 px-4 py-3 rounded-btn hover:bg-bg-soft text-text-muted mt-1">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="/admin/" class="flex items-center gap-3 px-4 py-3 rounded-btn hover:bg-bg-soft text-text-muted mt-1">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
