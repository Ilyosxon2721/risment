    ...
    <div class="min-h-screen flex" x-data="{ sidebarOpen: false }">
        ...
        >
            ...
            <nav class="p-4">
                ...
                <a href="{{ route('cabinet.calculations.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-btn {{ request()->routeIs('cabinet.calculations.*') ? 'bg-brand text-white' : 'hover:bg-bg-soft' }} mt-1">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path>
                    </svg>
                    <span>{{ __('Saved Calculations') }}</span>
                </a>
